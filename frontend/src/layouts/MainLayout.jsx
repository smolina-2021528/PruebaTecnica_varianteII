...
const MainLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-slate-50 text-slate-900 dark:bg-slate-900 dark:text-slate-100 transition-colors duration-200">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-slate-100 bg-white dark:border-slate-800 dark:bg-slate-800 transition-transform duration-300 lg:static lg:translate-x-0 ${
